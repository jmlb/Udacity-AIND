...
def heuristic_score1(game, player):
    ""
...
def heuristic_score2(game, player):
...
def heuristic_score3(game, player):
    ...
    my_moves = len(game.get_legal_moves(player))
    opp_moves = len(game.get_legal_moves(game.get_opponent(player)))    
    return (my_moves-opp_moves) / opp_moves


def heuristic_score4(game, player):
    ...
    my_moves = len(game.get_legal_moves(player))
    opp_moves = len(game.get_legal_moves(game.get_opponent(player)))    
    return (2*my_moves-opp_moves) / opp_moves
...
def custom_score(game, player):
    ...
    return heuristic_score1(game, player)
...
class CustomPlayer:
    ...
    def minimax(self, game, depth, maximizing_player=True):
        ...
        if maximizing_player:
            return max(scores_and_moves)  
        else:
            return min(scores_and_moves)
